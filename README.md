...
## 1. Crear un Ambiente Virtual (Entorno Virtual)

Crear un virtual enviroment para instalar las librerías necesarias de Python.
...
Iniciar el virtual enviroment para instalar las librerías necesarias para el proyecto.
...
Crear el archivo **requirements.txt** con las listas de las librerías y versiones de cada una, necesarias para el proyecto.
...
Crear el archivo **runtime.txt** con la versión Python3 utilizada.
...
## 9. Crear el punto de control comité.
